...
var availableCars = _.filter(_.prop('in_stock'));
var getPrice = _.pipe(_.prop('dollar_value'), accounting.formatMoney);
var availablePrices = _.pipe(availableCars, map(getPrice), _.join(', '));
